...
%         h.ft  = [nan nan]; h.fs  = [nan nan];
        ...
        [h.tx,h.sx, h.dhi, h.dlo,h.td ,h.d ] = signal_picks(h.ft ,h.fs );
    end
...
function plot_(h)
    ...
    if isempty(h.ft)
        if isempty(h.ft_)
            ...
            legend({'Signal','Sampled','D1','D2','FD2'});
        end
    else
        if isempty(h.ft_)
            plot( h.axes ...
            ...
            legend({'Signal','Sampled','D1','FD1','D2'});
        else
            plot( h.axes ...
                , h.t0 , h.s0 , '-k' ...  %TODO  %             
                , h.t  , h.s  , 'ok'  ...
            ...
            legend({'Signal','Sampled','D1','FD1','D2','FD2'});
        end
    end
