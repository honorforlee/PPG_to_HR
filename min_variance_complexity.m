...
%     sort_count = sort_count + 1;
%     sort_length = sort_length + length(clust_merge)-1;
%     
...
%     
%     sort_count = sort_count + 1; 
%     comp = comp + length(kx_major) - 1;
%     sort_length = sort_length + length(kx_major);
%     
% end
% 
...
% end
% 
% comp = comp + find_first_in;
% tbl_complexity = table(comp',mult',add',div',abs_count',sort_length',sort_count',find_first_in',isnan_comp',periodicity_count','VariableNames',{'comp','mult','add','div','abs','sort_l','sort_c','find_first','isnan_comp','per_c'});
